...
- `QA_TOOLS_SECRET` — optional secret that enables locked production QA helpers, including the XP-ready level-up test endpoint for signed sessions or active `QA...` test characters
